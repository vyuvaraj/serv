...
func (s *Server) handleCompletion(msg JSONRPCMessage) {
	...
	builtins := []CompletionItem{
		...
		{Label: "http.static", Kind: 3, Detail: "Serve static files at prefix path", InsertText: "http.static(\"$1\", \"$2\")"},
		...
		{Label: "time.sleep", Kind: 3, Detail: "Pause execution for milliseconds", InsertText: "time.sleep($1)"},
		...
		{Label: "store.get", Kind: 3, Detail: "Retrieve object from ServStore", InsertText: "store.get(\"$1\", \"$2\")"},
		{Label: "store.put", Kind: 3, Detail: "Upload object to ServStore", InsertText: "store.put(\"$1\", \"$2\", $3)"},
		{Label: "store.delete", Kind: 3, Detail: "Delete object from ServStore", InsertText: "store.delete(\"$1\", \"$2\")"},
		{Label: "mail.send", Kind: 3, Detail: "Send email notification", InsertText: "mail.send(\"$1\", \"$2\", \"$3\")"},
